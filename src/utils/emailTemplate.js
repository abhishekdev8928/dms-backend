...
// Email template for Welcome Email (Super Admin Created Users)
export const getWelcomeEmailTemplate = (username, email, temporaryPassword) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 12px; overflow: hidden; border: 1px solid #2a2a2a; max-width: 600px;">
                ...
                <tr>
                  <td style="padding: 0 30px 30px 30px;">
                    ...
                    <p style="margin: 0 0 30px; color: #e0e0e0; font-size: 15px; line-height: 1.6;">
                      Your account has been successfully created by our administrator. Welcome aboard! Below are your login credentials:
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding: 0 0 30px 0;">
                          <div style="background-color: #2a2a2a; border-radius: 8px; padding: 24px; border: 1px solid #3a3a3a;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="padding-bottom: 16px;">
                                  <p style="margin: 0 0 8px; color: #b0b0b0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Email
                                  </p>
                              ...
                              <tr>
                                <td style="padding-top: 16px; border-top: 1px solid #3a3a3a;">
                                  <p style="margin: 0 0 8px; color: #b0b0b0; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">
                                    Temporary Password
                                  </p>
                                  <p style="margin: 0; color: #ff6c37; font-size: 15px; font-weight: 600; font-family: 'Courier New', monospace;">
                                    ${temporaryPassword}
                                  </p>
                                </td>
                              </tr>
                    ...
                    <!-- Security Notice -->
                    <div style="background-color: #2a1a1a; border-left: 4px solid #ff6c37; padding: 16px 20px; border-radius: 4px; margin-bottom: 30px;">
                      <p style="margin: 0; color: #ffb088; font-size: 14px; line-height: 1.6;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding: 0 0 30px 0;">
                          <a href="${config.frontendUrl}/login" style="background-color: #ff6c37; color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 4px; font-size: 15px; font-weight: 500; display: inline-block;">
                    ...
                    <p style="margin: 0 0 20px; color: #b0b0b0; font-size: 14px; line-height: 1.6;">
                      If you have any questions or need assistance, please don't hesitate to reach out to our support team at <a href="mailto:help@yourdomain.com" style="color: #4a9eff; text-decoration: none;">help@yourdomain.com</a>.
                    </p>
